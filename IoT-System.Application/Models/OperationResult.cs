...
public class OperationResult<T>
{
    ...
    /// <param name="exception">The exception that occurred during the operation.</param>
    /// <param name="errors">A collection of error messages.</param>
    public OperationResult(bool isSuccess, T? data, Exception? exception, IEnumerable<string> errors) : this(isSuccess, exception, errors)
    {
        Data = data;
    }
    ...
    public static OperationResult<T> Failure(Exception? exception = null, IEnumerable<string>? errors = null)
